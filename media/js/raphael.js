...
(function () {
    ...
    R.type = (win.SVGAngle || doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") || document.createElement('canvas').getContext ? "SVG" : "VML");
    if (R.type == "VML") {
    ...
    if (R.svg) {
        ...
        Element[proto].show = function () {
            !this.removed && this.node.style && (this.node.style.display = "");
            return this;
        };
        ...
        Element[proto].getBBox = function () {
            ...
            if (this.type == "text" && this.node.getNumberOfChars) {
