            ...
            if (opts.stacked) {
                for (var i = 0; i < len; i++) {
                    ...
                    for (var j = 0; j < (multi || 1); j++) {
                        ...
                        if (j == multi - 1) {
                            var label = paper.raphael.g.labelise(labels[i], tot, total);
                ...
                for (var i = 0; i < len; i++) {
                    for (var j = 0; j < (multi || 1); j++) {
                        var label = paper.raphael.g.labelise(multi ? labels[j] && labels[j][i] : labels[i], multi ? values[j][i] : values[i], total);
