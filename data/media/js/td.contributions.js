$().ready(function() {
    ...
    var contributionFilter = new TD.DataFilter('#datafilter', 'a#previewData', 'a#downloadData', function() {
    ...
    contributionFilter.countPath = "/data/contributions/count/";
    contributionFilter.downloadPath = "/contributions/download/";
    contributionFilter.previewPath = "/contributions/";
    contributionFilter.shouldUseBulk = function() {
    ...
    contributionFilter.preview = function() {
            ...
            if (!this.shouldUseBulk()) {
                ...
                $.getJSON('/data/contributions/', params, function(data) {
                    if (data.length === 0) {
                        ...
                        contributionFilter.downloadNode.addClass('enabled');
                        $('div#nodata').hide();
    ...
    contributionFilter.registerFilter({
        name: 'amount',
        label: 'Amount',
    ...
    TD.activeFilter = contributionFilter;
